...
const CountryUSA = () => {
  const stats = [
    { number: "500+", label: "美国院校覆盖", description: "常春藤及TOP100院校全覆盖" },
    { number: "1,500+", label: "美国导师团队", description: "哈佛、MIT、斯坦福等名校背景" },
    { number: "97.5%", label: "通过率", description: "专业课程辅导通过率" }
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(${usaHero})` }}
        >
          <div className="absolute inset-0 bg-black/40"></div>
        </div>
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          <h1 className="text-6xl font-bold mb-6">美国留学</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">美国院校辅导服务</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">美国留学辅导服务</h2>
