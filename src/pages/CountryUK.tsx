...
const CountryUK = () => {
  ...
  const stats = [
    { number: "200+", label: "英国院校覆盖", description: "遍布英格兰、苏格兰、威尔士、北爱尔兰" },
    { number: "1,200+", label: "英国导师团队", description: "G5、罗素集团等名校背景" },
    { number: "98.5%", label: "通过率", description: "专业课程辅导通过率" }
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(${ukHero})` }}
        >
          <div className="absolute inset-0 bg-black/40"></div>
        </div>
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          <h1 className="text-6xl font-bold mb-6">英国留学</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">英国院校辅导服务</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">英国留学辅导服务</h2>
