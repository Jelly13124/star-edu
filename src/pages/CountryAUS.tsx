...
const CountryAUS = () => {
  const stats = [
    { number: "150+", label: "澳洲院校覆盖", description: "八大名校及其他优质院校全覆盖" },
    { number: "800+", label: "澳洲导师团队", description: "悉尼大学、墨尔本大学等名校背景" },
    { number: "97.8%", label: "通过率", description: "专业课程辅导通过率" }
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(${ausHero})` }}
        >
          <div className="absolute inset-0 bg-black/40"></div>
        </div>
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          <h1 className="text-6xl font-bold mb-6">澳洲留学</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">澳洲院校辅导服务</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">澳洲留学辅导服务</h2>
